...
router.get('/dashboard',checkAuth,(req,res)=>{
    urls.find({owned:req.user.eamil},(err, data)=>{
if(err) throw err;
...
if(err) throw err;
if(data){
res.render("dashboard",{verified : req.user.isVerified,logged:true, csrfToken:req.csrfToken(), err:"Try a diffrent or another url, This exist"} )
}else{
urls({
